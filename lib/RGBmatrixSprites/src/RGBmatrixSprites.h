#ifndef RGBmatrixSprites_h
#define RGBmatrixSprites_h
...
class cSprite
{
  ...
  public:
    ...
    void Render(RGBmatrixPanel *Matrix);
    void EdgeDetect(RGBmatrixPanel *Matrix);
...
{
  public:
    cLEDSprites(RGBmatrixPanel *Matrix);
